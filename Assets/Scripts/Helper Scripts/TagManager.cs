public static class TagManager
{
    ...
    public static string Hurt_ANIMATION_PARAMETER = "Hurt";
    public static string JumpHurt_ANIMATION_PARAMETER = "JumpHurt";
    public static string FallHurt_ANIMATION_PARAMETER = "FallHurt";
    public static string ATTACK_TRIGGER_PARAMETER = "AttackTrigger";
    ...
    public static string Hurt_ANIMATION_NAME = "Hurt";
    ...
    public static string SFX_DATA = "SFX";
